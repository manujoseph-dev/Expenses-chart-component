...
I learned to build a dynamic bar chart based on JSON data and add animation to the bars and numbers.


### Useful resources

- [Gsap](https://gsap.com) - This helped me to create text animation in html.A very usefull library for animation.
